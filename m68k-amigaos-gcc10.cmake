...
set(CMAKE_C_FLAGS "${FLAGS_COMMON} ${TOOLCHAIN_CFLAGS}")
set(CMAKE_CXX_FLAGS "${FLAGS_COMMON} ${TOOLCHAIN_CXXFLAGS}")
set(CMAKE_ASM_FLAGS "-m${M68K_CPU} -I${TOOLCHAIN_PATH}/m68k-amigaos/sys-include")
